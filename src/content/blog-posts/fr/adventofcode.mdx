...
![AoC](https://snapfilething.homeserver-ericp.fr/uploads/screenshot_2025-07-21_at_15-25-44_advent_of_code_2022_1753104350_9adaa2ee_.png)
...
J'ai commencé par lister les langages que je connaissais bien, mélangés avec d'autres dont j'avais entendu parler mais que je n'avais jamais touchés. Ma logique était brillamment défaillante : "Les premiers défis sont censés être faciles, donc je vais commencer par les langages que je ne connais pas et garder ceux que je maîtrise pour les trucs difficiles à la fin."
...
![TDD](https://snapfilething.homeserver-ericp.fr/uploads/tdd_1753104566_74609228_.jpeg)
...
![First part](https://snapfilething.homeserver-ericp.fr/uploads/firstpart_1753104637_71a27a9a_.png)

J'ai même commencé à partager mes progrès quotidiens sur la communauté Reddit officielle d'Advent of Code. La réponse était encourageante ! Les gens étaient vraiment intéressés par mon expérience "un langage par jour". La communauté là-bas est incroyable – vous y trouverez tout, des solutions élégantes aux délires complets comme résoudre les puzzles en un minimum de lignes ou utiliser des langages complètement obscurs.

![Reddit Comments](https://snapfilething.homeserver-ericp.fr/uploads/screenshot_2025-07-21_at_15-32-34_advent_of_code_1753104763_f5cdc713_.png)
...
![Timeline](https://snapfilething.homeserver-ericp.fr/uploads/screenshot_2025-07-21_at_15-21-26_excalidraw_1753104105_146fa0d4_.png)
...
![Broken WSL](https://snapfilething.homeserver-ericp.fr/uploads/screenshot_2025-07-21_at_15-41-23_excalidraw_1753105290_4985aba2_.png)
...
Quand le 25 décembre est finalement arrivé et que j'ai posté ma solution finale, le sentiment d'accomplissement était incroyable. Je l'avais vraiment fait; 25 jours, 25 langages, 50 parties de puzzles résolues.
...
![Reddit](https://github.com/Eric-Philippe/Advent-Of-Code-2022/blob/master/img%20%F0%9F%96%BC%EF%B8%8F/aoc_2.png?raw=true)

J'étais aussi fier de maintenir une série parfaite de commits – chaque jour de décembre avait au moins un commit dans mon dépôt de solutions. Il y a quelque chose de satisfaisant dans ce graphique de complètement tout vert.
...
![Diversity](https://snapfilething.homeserver-ericp.fr/uploads/screenshot_2025-07-21_at_15-23-25_eric-philippe_advent-of-code-2022_this_is_a_multi-language_repository_for_my_solutions_to_the_advent_of_code_2022_puzzles_1753104230_b80da656_.png)
...
Certains langages que je pensais difficiles se sont révélés délicieux (Rust). D'autres que j'attendais simples, m'ont posé des défis inattendus (Haskell).
