...
export default function PhotoHead({
  ...
  return (
    <motion.section
      ref={containerRef}
      className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-800"
      style={{ scale, opacity }}
    >
      ...
      <motion.div
        className="absolute top-10 left-10 font-mono text-xs tracking-wider text-white/30"
      ...
      <motion.div
        className="absolute top-22 right-20 font-mono text-xs tracking-wider text-white/30"
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
